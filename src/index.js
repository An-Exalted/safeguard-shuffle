...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    for (let i = 0; i < 3; i++) {
      for (let j = 0; j < 2; j++) {
        ...
        // Set the table's physics body to use a circle for collisions
        table.setOrigin(0.5, 0.5);
        let radius = (table.width*1)/2;
        table.body.setCircle(radius);
        table.body.offset.x = 0;
        table.body.offset.y = 0;
    ...
    let table1X = startX + 0 * tableSpacing;
    let table1Y = startY + 0 * tableSpacing;
    this.Customer1Icon = this.add.image(table1X, table1Y - 30, 'notification').setScale(0.1);

    // Customer 2 Icon (Top-center table)
    let table2X = startX + 1 * tableSpacing;
    let table2Y = startY + 0 * tableSpacing;
    this.Customer2Icon = this.add.image(table2X, table2Y - 30, 'notification').setScale(0.1);

    // Customer 3 Icon (Top-right table)
    let table3X = startX + 2 * tableSpacing;
    let table3Y = startY + 0 * tableSpacing;
    this.Customer3Icon = this.add.image(table3X, table3Y - 30, 'notification').setScale(0.1);

    // Customer 4 Icon (Bottom-left table)
    let table4X = startX + 0 * tableSpacing;
    let table4Y = startY + 1 * tableSpacing;
    this.Customer4Icon = this.add.image(table4X, table4Y - 30, 'notification').setScale(0.1);

    // Customer 5 Icon (Bottom-center table)
    let table5X = startX + 1 * tableSpacing;
    let table5Y = startY + 1 * tableSpacing;
    this.Customer5Icon = this.add.image(table5X, table5Y - 30, 'notification').setScale(0.1);

    // Customer 6 Icon (Bottom-right table)
    let table6X = startX + 2 * tableSpacing;
    let table6Y = startY + 1 * tableSpacing;
    this.Customer6Icon = this.add.image(table6X, table6Y - 30, 'notification').setScale(0.1);
    ...
    this.inventoryButton.on('pointerover', () => {
        this.inventoryButton.setScale(0.27);  // Slightly increase size when hovering
    });

    this.inventoryButton.on('pointerout', () => {
        this.inventoryButton.setScale(0.25);  // Reset size when hover ends
    });
  ...
  onSubmitButton1Click() {
    ...
    if (isOrderMatched) {
      ...
      this.Customer1Icon.setTexture('fulfilled').setScale(0.05);
  ...
  onSubmitButton2Click() {
    ...
    if (isOrderMatched) {
      ...
      this.Customer2Icon.setTexture('fulfilled').setScale(0.05);
      this.player.inventoryCategories.forEach(category => {
          category.item = "None"; // Reset the item to "None" for each inventory category
      });
     }
  ...
  onSubmitButton3Click() {
    ...
    if (isOrderMatched) {
      ...
      this.Customer3Icon.setTexture('fulfilled').setScale(0.05);
      this.player.inventoryCategories.forEach(category => {
          category.item = "None"; // Reset the item to "None" for each inventory category
      });
     }
  ...
  onSubmitButton4Click() {
    ...
    if (isOrderMatched) {
      ...
      this.Customer4Icon.setTexture('fulfilled').setScale(0.05);
      this.player.inventoryCategories.forEach(category => {
          category.item = "None"; // Reset the item to "None" for each inventory category
      });
     }
  ...
  onSubmitButton5Click() {
    ...
    if (isOrderMatched) {
      ...
      this.Customer5Icon.setTexture('fulfilled').setScale(0.05);
      this.player.inventoryCategories.forEach(category => {
          category.item = "None"; // Reset the item to "None" for each inventory category
      });
     }
  ...
  onSubmitButton6Click() {
    ...
    if (isOrderMatched) {
      ...
      this.Customer6Icon.setTexture('fulfilled').setScale(0.05);
...
//////////////////////////////
  ...
  update() {
    ...
    if (distanceToTable1 < 105 && !this.isCustomer1Fulfilled) {             
    ...
    if (distanceToTable2 < 105 && !this.isCustomer2Fulfilled) {             
    ...
    if (distanceToTable3 < 105 && !this.isCustomer3Fulfilled) {             
    ...
    if (distanceToTable4 < 105 && !this.isCustomer4Fulfilled) {             
    ...
    if (distanceToTable5 < 105 && !this.isCustomer5Fulfilled) {             
    ...
    if (distanceToTable6 < 105 && !this.isCustomer6Fulfilled) {              // Adjustable the distance threshold
